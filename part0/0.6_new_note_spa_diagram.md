...
sequenceDiagram
  ...
  user->>browser: Go to "s://studies.cs.helsinki.fi/exampleapp/spa"

  note over browser: Browser sends  GET request <br> to server for static assets from URL
  ...
  browser->>server:  POST /exampleapp/new_note_spa, body: {content: "it's a new note", date:...}
